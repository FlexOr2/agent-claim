...
```bash
uv tool install git+https://github.com/FlexOr2/agent-claim.git@v0.3.0
# or: pipx install git+https://github.com/FlexOr2/agent-claim.git@v0.3.0
...
git+https://github.com/FlexOr2/agent-claim.git@v0.2.0`.
